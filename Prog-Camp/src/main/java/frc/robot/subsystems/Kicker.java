...
public class Kicker extends SubsystemBase {
    ...
    public void runKicker() {
        ...
        // KickerRightController.setSetpoint(KickerConstants.KICKER_REVERSE_RPM,
        //         ControlType.kMAXMotionVelocityControl);

    }

    public void runKickerReverse() {
        KickerLeftController.setSetpoint(KickerConstants.KICKER_REVERSE_RPM,
                ControlType.kMAXMotionVelocityControl);
        // KickerRightController.setSetpoint(KickerConstants.KICKERß_RPM,
                // ControlType.kMAXMotionVelocityControl);
    ...
    public Command runHKickerCommand() {

        ...
        public static final class KickerSubsystem {
            ...
            // public static final SparkFlexConfig PushoutRightMotorConfig = new SparkFlexConfig();
                ...
                static {
                        ...
                        PushoutMotorLeftConfig.idleMode(IdleMode.kBrake).smartCurrentLimit(40).voltageCompensation(12);
                        PushoutMotorRightConfig.idleMode(IdleMode.kBrake).smartCurrentLimit(40).voltageCompensation(12).inverted(true);



                        PushoutMotorLeftConfig.closedLoop.feedbackSensor(FeedbackSensor.kPrimaryEncoder)
                            // Set PID values for position control. We don't need to pass a closed
                            // loop slot, as it will default to slot 0.
                        ...
                        PushoutMotorRightConfig.closedLoop.feedbackSensor(FeedbackSensor.kPrimaryEncoder)
                            // Set PID values for position control. We don't need to pass a closed
                            // loop slot, as it will default to slot 0.
                            .p(PushoutConstants.p)
                            .i(PushoutConstants.i)
